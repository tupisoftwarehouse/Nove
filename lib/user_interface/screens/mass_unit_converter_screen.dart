...
class MassUnitConverterScreen extends StatefulWidget {
  final MassUnitConverterViewModel massUnitConverterViewModel;
  final Router router;

  const MassUnitConverterScreen({
    super.key,
  ...
  @override
  State<MassUnitConverterScreen> createState() {
    return _MassUnitConverterScreenState();
  }
}

class _MassUnitConverterScreenState extends State<MassUnitConverterScreen> {
  late final ThemeViewModel _themeViewModel;
  late final DeviceLanguageStringsViewModel _deviceLanguageStringsViewModel;
  late final ValueNotifier<List<MassUnitInput>> _listOfMassUnitInputs;
  ...
  void initState() {
    ...
    _listOfMassUnitInputs = ValueNotifier([]);
    ...
    ListOfMassUnitInputDataLoadingTransactionScript.loadListOfMassUnitInputData(
      _listOfMassUnitInputs,
      widget.massUnitConverterViewModel,
      _deviceLanguageStringsViewModel,
    );

    widget.massUnitConverterViewModel.listOfMassUnits.addListener(() {
      if (isListOfMeasureUnitsResized(
        widget.massUnitConverterViewModel.listOfMassUnits.value.length,
        _listOfMassUnitInputs.value.length,
      )) {
        ListOfMassUnitInputDataLoadingTransactionScript.loadListOfMassUnitInputData(
          _listOfMassUnitInputs,
          widget.massUnitConverterViewModel,
    ...
    widget.massUnitConverterViewModel.baseMassUnitIndex.addListener(() {
      ListOfMassUnitInputDataUpdatingTransactionScript.updateListOfMassUnitInputData(
        _listOfMassUnitInputs,
        widget.massUnitConverterViewModel,
        _deviceLanguageStringsViewModel,
            ...
            Scaffold(
              ...
              actionButtons: [
                ValueListenableBuilder(
                  valueListenable:
                      widget.massUnitConverterViewModel.listOfMassUnits,
                  builder: (_, listOfMassUnits, _) {
                    return AnimatedScale(
                      scale: isConverterUnchanged(listOfMassUnits) ? 0 : 1,
                      ...
                      child: ActionButton(
                        ...
                        onTap: () {
                          widget.massUnitConverterViewModel.reset();

                          _listOfMassUnitInputs.value.first.controller.text =
                              ZEROED_VALUE;

                          _listOfMassUnitInputs.value = [
                            _listOfMassUnitInputs.value.first,
                          ];
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: IconButton(
                            ...
                            onTap:
                                widget.massUnitConverterViewModel.addMassUnit,
                          ),
                        ),
                      ],
                    ),
                  ...
                  return isSnackbarShown
                      ? Snackbar(
                          message: deviceLanguageStrings
                              .RESTORE_DELETED_LIST_OF_MASS_UNITS_MESSAGE,
                          description: deviceLanguageStrings
                              .RESTORE_DELETED_LIST_OF_MASS_UNITS_DESCRIPTION,
                          ...
                          onTap: () {
                            widget.massUnitConverterViewModel.restore();
                          ...
                          onTimeout: () {
                            widget.massUnitConverterViewModel.dismissRecovery();
