...
class AreaUnitConverterScreen extends StatefulWidget {
  final AreaUnitConverterViewModel areaUnitConverterViewModel;
  final Router router;

  const AreaUnitConverterScreen({
    super.key,
  ...
  @override
  State<AreaUnitConverterScreen> createState() {
    return _AreaUnitConverterScreenState();
  }
}

class _AreaUnitConverterScreenState extends State<AreaUnitConverterScreen> {
  late final ThemeViewModel _themeViewModel;
  late final DeviceLanguageStringsViewModel _deviceLanguageStringsViewModel;
  late final ValueNotifier<List<AreaUnitInput>> _listOfAreaUnitInputs;
  ...
  void initState() {
    ...
    _listOfAreaUnitInputs = ValueNotifier([]);
    ...
    ListOfAreaUnitInputDataLoadingTransactionScript.loadListOfAreaUnitInputData(
      _listOfAreaUnitInputs,
      widget.areaUnitConverterViewModel,
      _deviceLanguageStringsViewModel,
    );

    widget.areaUnitConverterViewModel.listOfAreaUnits.addListener(() {
      if (isListOfMeasureUnitsResized(
        widget.areaUnitConverterViewModel.listOfAreaUnits.value.length,
        _listOfAreaUnitInputs.value.length,
      )) {
        ListOfAreaUnitInputDataLoadingTransactionScript.loadListOfAreaUnitInputData(
          _listOfAreaUnitInputs,
          widget.areaUnitConverterViewModel,
    ...
    widget.areaUnitConverterViewModel.baseAreaUnitIndex.addListener(() {
      ListOfAreaUnitInputDataUpdatingTransactionScript.updateListOfAreaUnitInputData(
        _listOfAreaUnitInputs,
        widget.areaUnitConverterViewModel,
        _deviceLanguageStringsViewModel,
            ...
            Scaffold(
              ...
              actionButtons: [
                ValueListenableBuilder(
                  valueListenable:
                      widget.areaUnitConverterViewModel.listOfAreaUnits,
                  builder: (_, listOfAreaUnits, _) {
                    return AnimatedScale(
                      scale: isConverterUnchanged(listOfAreaUnits) ? 0 : 1,
                      ...
                      child: ActionButton(
                        ...
                        onTap: () {
                          widget.areaUnitConverterViewModel.reset();

                          _listOfAreaUnitInputs.value.first.controller.text =
                              ZEROED_VALUE;

                          _listOfAreaUnitInputs.value = [
                            _listOfAreaUnitInputs.value.first,
                          ];
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: IconButton(
                            ...
                            onTap:
                                widget.areaUnitConverterViewModel.addAreaUnit,
                          ),
                        ),
                      ],
                    ),
                  ...
                  return isSnackbarShown
                      ? Snackbar(
                          message: deviceLanguageStrings
                              .RESTORE_DELETED_LIST_OF_AREA_UNITS_MESSAGE,
                          description: deviceLanguageStrings
                              .RESTORE_DELETED_LIST_OF_AREA_UNITS_DESCRIPTION,
                          ...
                          onTap: () {
                            widget.areaUnitConverterViewModel.restore();
                          ...
                          onTimeout: () {
                            widget.areaUnitConverterViewModel.dismissRecovery();
