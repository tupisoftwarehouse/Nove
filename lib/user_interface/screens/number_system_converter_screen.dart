...
class NumberSystemConverterScreen extends StatefulWidget {
  ...
  const NumberSystemConverterScreen({
    super.key,
  ...
  State<NumberSystemConverterScreen> createState() {
    return _NumberSystemConverterScreenState();
  }
}
...
class _NumberSystemConverterScreenState
  ...
  late final ValueNotifier<List<NumberSystemInput>> _listOfNumberSystemInputs;
  ...
  void initState() {
    ...
    _listOfNumberSystemInputs = ValueNotifier([]);
    ...
    ListOfNumberSystemInputDataLoadingTransactionScript.loadListOfNumberSystemInputData(
      _listOfNumberSystemInputs,
      widget.numberSystemConverterViewModel,
      _deviceLanguageStringsViewModel,
    );

    widget.numberSystemConverterViewModel.listOfNumberSystems.addListener(() {
      if (isListOfMeasureUnitsResized(
        widget.numberSystemConverterViewModel.listOfNumberSystems.value.length,
        _listOfNumberSystemInputs.value.length,
      )) {
        ListOfNumberSystemInputDataLoadingTransactionScript.loadListOfNumberSystemInputData(
          _listOfNumberSystemInputs,
          widget.numberSystemConverterViewModel,
    ...
    widget.numberSystemConverterViewModel.baseNumberSystemIndex.addListener(() {
      ListOfNumberSystemInputDataUpdatingTransactionScript.updateListOfNumberSystemInputData(
        _listOfNumberSystemInputs,
        widget.numberSystemConverterViewModel,
        _deviceLanguageStringsViewModel,
            ...
            Scaffold(
              ...
              actionButtons: [
                ValueListenableBuilder(
                  valueListenable:
                      widget.numberSystemConverterViewModel.listOfNumberSystems,
                  builder: (_, listOfNumberSystems, _) {
                    return AnimatedScale(
                      scale: isConverterUnchanged(listOfNumberSystems) ? 0 : 1,
                      ...
                      child: ActionButton(
                        ...
                        onTap: () {
                          widget.numberSystemConverterViewModel.reset();
                          ...
                          _listOfNumberSystemInputs.value = [
                            _listOfNumberSystemInputs.value.first,
                          ];
                  ...
                  return isSnackbarShown
                      ? Snackbar(
                          ...
                          description: deviceLanguageStrings
                              .RESTORE_DELETED_LIST_OF_NUMBER_SYSTEM_DESCRIPTION,
                          ...
                          onTap: () {
                            widget.numberSystemConverterViewModel.restore();
