...
class TemperatureUnitConverterScreen extends StatefulWidget {
  final TemperatureUnitConverterViewModel temperatureUnitConverterViewModel;
  final Router router;

  const TemperatureUnitConverterScreen({
    super.key,
  ...
  @override
  State<TemperatureUnitConverterScreen> createState() {
    return _TemperatureUnitConverterScreenState();
  }
}

class _TemperatureUnitConverterScreenState
    extends State<TemperatureUnitConverterScreen> {
  late final ThemeViewModel _themeViewModel;
  late final DeviceLanguageStringsViewModel _deviceLanguageStringsViewModel;
  late final ValueNotifier<List<TemperatureUnitInput>>
  _listOfTemperatureUnitInputs;
  ...
  void initState() {
    ...
    _listOfTemperatureUnitInputs = ValueNotifier([]);
    ...
    ListOfTemperatureUnitInputDataLoadingTransactionScript.loadListOfTemperatureUnitInputData(
      _listOfTemperatureUnitInputs,
      widget.temperatureUnitConverterViewModel,
      _deviceLanguageStringsViewModel,
    );

    widget.temperatureUnitConverterViewModel.listOfTemperatureUnits.addListener(() {
      if (isListOfMeasureUnitsResized(
        widget
            ...
            .value
            .length,
        _listOfTemperatureUnitInputs.value.length,
      )) {
        ListOfTemperatureUnitInputDataLoadingTransactionScript.loadListOfTemperatureUnitInputData(
          _listOfTemperatureUnitInputs,
          widget.temperatureUnitConverterViewModel,
    ...
    widget.temperatureUnitConverterViewModel.baseTemperatureUnitIndex.addListener(
      () {
        ListOfTemperatureUnitInputDataUpdatingTransactionScript.updateListOfTemperatureUnitInputData(
          _listOfTemperatureUnitInputs,
          widget.temperatureUnitConverterViewModel,
                ...
                ValueListenableBuilder(
                  ...
                  builder: (_, listOfTemperatureUnits, _) {
                    return AnimatedScale(
                      scale: isConverterUnchanged(listOfTemperatureUnits)
                          ? 0
                          : 1,
                      ...
                      child: ActionButton(
                        ...
                        onTap: () {
                          widget.temperatureUnitConverterViewModel.reset();
                          ...
                          _listOfTemperatureUnitInputs.value = [
                            _listOfTemperatureUnitInputs.value.first,
                          ];
                  ...
                  return isSnackbarShown
                      ? Snackbar(
                          message: deviceLanguageStrings
                              .RESTORE_DELETED_LIST_OF_TEMPERATURE_UNITS_MESSAGE,
                          description: deviceLanguageStrings
                              .RESTORE_DELETED_LIST_OF_TEMPERATURE_UNITS_DESCRIPTION,
                          ...
                          onTap: () {
                            widget.temperatureUnitConverterViewModel.restore();
