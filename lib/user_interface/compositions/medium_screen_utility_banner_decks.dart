...
class MediumScreenUtilityBannerDecks extends StatelessWidget {
  final DeviceLanguageStringsViewModel deviceLanguageStringsViewModel;
  final Router router;

  const MediumScreenUtilityBannerDecks({
    super.key,
                    ...
                    children: [
                      ...
                      Flexible(
                        child: UtilityBanner(
                          ...
                          onTap: () {
                            router.navigateToBodyMassIndexCalculatorScreen(
                              context,
                            );
                          },
                        ),
                    ...
                    children: [
                      Flexible(
                        child: UtilityBanner(
                          ...
                          onTap: () {
                            router.navigateToCurrencyUnitConverterScreen(
                              context,
                            );
                          },
                        ),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: UtilityBanner(
                          ...
                          onTap: () {
                            router.navigateToNumberSystemConverterScreen(
                              context,
                            );
                          },
                        ),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: UtilityBanner(
                          ...
                          onTap: () {
                            router.navigateToTemperatureUnitConverterScreen(
                              context,
                            );
                          },
                        ),
                    ...
                    children: [
                      Flexible(
                        child: UtilityBanner(
                          ...
                          onTap: () {
                            router.navigateToTextInformationParserScreen(
                              context,
                            );
                          },
                        ),
