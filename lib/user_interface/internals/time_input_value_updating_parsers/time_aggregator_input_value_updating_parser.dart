...
class TimeAggregatorInputValueUpdatingParser {
  TimeAggregatorInputValueUpdatingParser._();
  ...
  static void updateHoursFromTime(
    ...
    try {
      final updateTimeHours = int.tryParse(updatedInputValue);

      if (isAggregatedTimeHourNumberOverflowing(updatedInputValue.length)) {
