...
class ListOfSpeedUnitInputDataUpdatingTransactionScript {
  ListOfSpeedUnitInputDataUpdatingTransactionScript._();

  static void updateListOfSpeedUnitInputData(
    ...
    ListOfMeasureUnitInputDataUpdatingTransactionScript.updateListOfMeasureUnitInputData(
      ...
      speedUnitConverterViewModel.baseSpeedUnitIndex.value,
