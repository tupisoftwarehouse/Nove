...
class InchPerSecondUnitEntity extends SpeedUnitEntity {
  InchPerSecondUnitEntity(String value)
    : super(value, SpeedUnit.INCH_PER_SECOND);
    ...
    switch (speedUnitToConvertTo.measureUnit) {
      case SpeedUnit.LIGHTSPEED:
        convertedToSpeedUnitValue =
            ...
            LIGHTSPEED_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.FOOT_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            FOOT_PER_SECOND_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.KILOMETER_PER_HOUR:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            KILOMETER_PER_HOUR_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.KILOMETER_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            KILOMETER_PER_SECOND_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.KNOT:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            KNOT_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.MACH:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            MACH_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.METER_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            METER_PER_SECOND_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.MILE_PER_HOUR:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            MILE_PER_HOUR_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.MILE_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            MILE_PER_SECOND_IN_INCH_PER_SECOND_CONVERSION_MULTIPLIER;
