...
class MeterPerSecondUnitEntity extends SpeedUnitEntity {
  MeterPerSecondUnitEntity(String value)
    : super(value, SpeedUnit.METER_PER_SECOND);
    ...
    switch (speedUnitToConvertTo.measureUnit) {
      case SpeedUnit.LIGHTSPEED:
        convertedToSpeedUnitValue =
            ...
            LIGHTSPEED_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.FOOT_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            FOOT_PER_SECOND_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.INCH_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            INCH_PER_SECOND_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;
      ...
      case SpeedUnit.KILOMETER_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            KILOMETER_PER_SECOND_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.KNOT:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            KNOT_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.MACH:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            MACH_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.MILE_PER_HOUR:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            MILE_PER_HOUR_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;

        break;
      case SpeedUnit.MILE_PER_SECOND:
        convertedToSpeedUnitValue =
            double.parse(speedUnitToConvertTo.value) *
            MILE_PER_SECOND_IN_METER_PER_SECOND_CONVERSION_MULTIPLIER;
