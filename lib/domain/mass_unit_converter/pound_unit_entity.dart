...
class PoundUnitEntity extends MassUnitEntity {
  PoundUnitEntity(String value) : super(value, MassUnit.POUND);
    ...
    switch (massUnitToConvertTo.measureUnit) {
      case MassUnit.GRAM:
        convertedToMassUnitValue =
            ...
            GRAM_IN_POUND_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.KILOGRAM:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            KILOGRAM_IN_POUND_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.MILLIGRAM:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            MILLIGRAM_IN_POUND_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.OUNCE:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            OUNCE_IN_POUND_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.TONNE:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            TONNE_IN_POUND_CONVERSION_MULTIPLIER;
