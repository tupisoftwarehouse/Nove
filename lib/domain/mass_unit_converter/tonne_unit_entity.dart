...
class TonneUnitEntity extends MassUnitEntity {
  TonneUnitEntity(String value) : super(value, MassUnit.TONNE);
    ...
    switch (massUnitToConvertTo.measureUnit) {
      case MassUnit.GRAM:
        convertedToMassUnitValue =
            ...
            GRAM_IN_TONNE_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.KILOGRAM:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            KILOGRAM_IN_TONNE_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.MILLIGRAM:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            MILLIGRAM_IN_TONNE_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.OUNCE:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            OUNCE_IN_TONNE_CONVERSION_MULTIPLIER;

        break;
      case MassUnit.POUND:
        convertedToMassUnitValue =
            double.parse(massUnitToConvertTo.value) *
            POUND_IN_TONNE_CONVERSION_MULTIPLIER;
