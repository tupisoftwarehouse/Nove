...
class HectareUnitEntity extends AreaUnitEntity {
  HectareUnitEntity(String value) : super(value, AreaUnit.HECTARE);
    ...
    switch (areaUnitToConvertTo.measureUnit) {
      case AreaUnit.ACRE:
        convertedToAreaUnitValue =
            ...
            ACRE_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_CENTIMETER:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_CENTIMETER_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_INCH:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_INCH_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_YARD:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_YARD_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_FOOT:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_FOOT_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_METER:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_METER_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_KILOMETER:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_KILOMETER_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_MILE:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_MILE_IN_HECTARE_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_MILLIMETER:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_MILLIMETER_IN_HECTARE_CONVERSION_MULTIPLIER;
