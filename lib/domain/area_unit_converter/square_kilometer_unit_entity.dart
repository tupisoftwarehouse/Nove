...
class SquareKilometerUnitEntity extends AreaUnitEntity {
  SquareKilometerUnitEntity(String value)
    : super(value, AreaUnit.SQUARE_KILOMETER);
    ...
    switch (areaUnitToConvertTo.measureUnit) {
      case AreaUnit.ACRE:
        convertedToAreaUnitValue =
            ...
            ACRE_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.HECTARE:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            HECTARE_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_CENTIMETER:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_CENTIMETER_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_YARD:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_YARD_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_FOOT:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_FOOT_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_INCH:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_INCH_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_METER:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_METER_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_MILE:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_MILE_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;

        break;
      case AreaUnit.SQUARE_MILLIMETER:
        convertedToAreaUnitValue =
            double.parse(areaUnitToConvertTo.value) *
            SQUARE_MILLIMETER_IN_SQUARE_KILOMETER_CONVERSION_MULTIPLIER;
