...
class MinuteUnitEntity extends TimeUnitEntity {
  MinuteUnitEntity(String value) : super(value, TimeUnit.MINUTE);
    ...
    switch (timeUnitToConvertTo.measureUnit) {
      case TimeUnit.DAY:
        convertedToTimeUnitValue =
            ...
            DAY_IN_MINUTE_CONVERSION_MULTIPLIER;

        break;
      case TimeUnit.HOUR:
        convertedToTimeUnitValue =
            double.parse(timeUnitToConvertTo.value) *
            HOUR_IN_MINUTE_CONVERSION_MULTIPLIER;

        break;
      case TimeUnit.MILLISECOND:
        convertedToTimeUnitValue =
            double.parse(timeUnitToConvertTo.value) *
            MILLISECOND_IN_MINUTE_CONVERSION_MULTIPLIER;

        break;
      case TimeUnit.SECOND:
        convertedToTimeUnitValue =
            double.parse(timeUnitToConvertTo.value) *
            SECOND_IN_MINUTE_CONVERSION_MULTIPLIER;

        break;
      case TimeUnit.WEEK:
        convertedToTimeUnitValue =
            double.parse(timeUnitToConvertTo.value) *
            WEEK_IN_MINUTE_CONVERSION_MULTIPLIER;

        break;
      case TimeUnit.YEAR:
        convertedToTimeUnitValue =
            double.parse(timeUnitToConvertTo.value) *
            YEAR_IN_MINUTE_CONVERSION_MULTIPLIER;
