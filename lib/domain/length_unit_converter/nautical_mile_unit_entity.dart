...
class NauticalMileUnitEntity extends LengthUnitEntity {
  NauticalMileUnitEntity(String value) : super(value, LengthUnit.NAUTICAL_MILE);
    ...
    switch (lengthUnitToConvertTo.measureUnit) {
      case LengthUnit.MILLIMETER:
        convertedToLengthUnitValue =
            ...
            MILLIMETER_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.CENTIMETER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            CENTIMETER_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.METER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            METER_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.KILOMETER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            KILOMETER_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.INCH:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            INCH_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.FOOT:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            FOOT_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.YARD:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            YARD_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.MILE:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            MILE_IN_NAUTICAL_MILE_CONVERSION_MULTIPLIER;
