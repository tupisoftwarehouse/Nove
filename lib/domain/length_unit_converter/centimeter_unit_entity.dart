...
class CentimeterUnitEntity extends LengthUnitEntity {
  CentimeterUnitEntity(String value) : super(value, LengthUnit.CENTIMETER);
    ...
    switch (lengthUnitToConvertTo.measureUnit) {
      case LengthUnit.MILLIMETER:
        convertedToLengthUnitValue =
            ...
            MILLIMETER_IN_CENTIMETER_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.METER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            METER_IN_CENTIMETER_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.KILOMETER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            KILOMETER_IN_CENTIMETER_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.INCH:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            INCH_IN_CENTIMETER_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.FOOT:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            FOOT_IN_CENTIMETER_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.YARD:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            YARD_IN_CENTIMETER_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.MILE:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            MILE_IN_CENTIMETER_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.NAUTICAL_MILE:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            NAUTICAL_MILE_IN_CENTIMETER_CONVERSION_MULTIPLIER;
