...
class YardUnitEntity extends LengthUnitEntity {
  YardUnitEntity(String value) : super(value, LengthUnit.YARD);
    ...
    switch (lengthUnitToConvertTo.measureUnit) {
      case LengthUnit.MILLIMETER:
        convertedToLengthUnitValue =
            ...
            MILLIMETER_IN_YARD_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.CENTIMETER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            CENTIMETER_IN_YARD_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.METER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            METER_IN_YARD_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.KILOMETER:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            KILOMETER_IN_YARD_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.INCH:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            INCH_IN_YARD_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.FOOT:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            FOOT_IN_YARD_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.MILE:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            MILE_IN_YARD_CONVERSION_MULTIPLIER;

        break;
      case LengthUnit.NAUTICAL_MILE:
        convertedToLengthUnitValue =
            double.parse(lengthUnitToConvertTo.value) *
            NAUTICAL_MILE_IN_YARD_CONVERSION_MULTIPLIER;
