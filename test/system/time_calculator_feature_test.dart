...
void main() {
  group("Test \"Time Calculator\" Feature", () {
    ...
    testWidgets("Test Resetting Time Calculator Data", (tester) async {
    ...
    testWidgets("Test Restoring Time Calculator Data", (tester) async {
      timeCalculatorViewModel.firstTimeToBeCalculated.value =
          TIME_TO_BE_CALCULATED;
      timeCalculatorViewModel.secondTimeToBeCalculated.value =
          TIME_TO_BE_CALCULATED;
    ...
    testWidgets("Test Executing Time Adding", (tester) async {
      await tester.pumpWidget(
        material.MaterialApp(
          home: TimeCalculatorScreen(
            timeCalculatorViewModel: timeCalculatorViewModel,
    ...
    testWidgets("Test Executing Time Subtraction", (tester) async {
      await tester.pumpWidget(
        material.MaterialApp(
          home: TimeCalculatorScreen(
            timeCalculatorViewModel: timeCalculatorViewModel,
