...
void main() {
  group("Test \"ListOfLengthUnitInputDataUpdatingTransactionScript\" Class", () {
    ...
    test(
      "Test If Method \"updateListOfLengthUnitInputData\" Updates The List Of Length Unit Input Data With View Model Data And Previous Text Selection But Keep Value Of Base Length Unit Input",
      () {
        ...
        expect(listOfLengthUnitInputs.value.first.controller.text, "");
        expect(
          listOfLengthUnitInputs.value.last.controller.text,
          lengthUnitConverterViewModel.listOfLengthUnits.value.last.value,
        );
      },
    );
  });
