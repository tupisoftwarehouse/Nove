...
void main() {
  group("Test \"NotScientificCalculatorKeyboard\" Composition", () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          material.MaterialApp(
            home: material.Scaffold(
              body: NotScientificCalculatorKeyboard(
                calculatorViewModel: calculatorViewModel,
                deviceLanguageStringsViewModel: deviceLanguageStringsViewModel,
        ...
        expect(
          ...
          EXPRESSION_WITH_ALL_AVAILABLE_CHARACTERS_IN_NOT_SCIENTIFIC_KEYBOARD,
        );
        expect(
