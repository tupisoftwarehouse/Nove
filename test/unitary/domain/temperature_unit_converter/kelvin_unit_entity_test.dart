  ...
  group("Test \"KelvinUnitEntity\" Entity", () {
    test(
      ...
      () {
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TEMPERATURE_UNIT_VALUE,
          FAHRENHEIT_IN_KELVIN_CONVERSION_FORMULA(TEMPERATURE_UNIT_VALUE),
        );
