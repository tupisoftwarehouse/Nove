...
void main() {
  group("Test \"CelsiusUnitEntity\" Entity", () {
    test(
      "Test If Method \"convertTo\" Converts To Temperature Unit Value But Keeping Current Temperature Unit",
      () {
        final instance = CelsiusUnitEntity(ZEROED_TEMPERATURE_UNIT_VALUE);
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          ...
          FAHRENHEIT_IN_CELSIUS_CONVERSION_FORMULA(TEMPERATURE_UNIT_VALUE),
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TEMPERATURE_UNIT_VALUE,
          KELVIN_IN_CELSIUS_CONVERSION_FORMULA(TEMPERATURE_UNIT_VALUE),
        );
