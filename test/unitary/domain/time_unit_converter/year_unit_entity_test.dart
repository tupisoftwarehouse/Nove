...
void main() {
  group("Test \"YearUnitEntity\" Entity", () {
    test(
      "Test If Method \"convertTo\" Converts To Time Unit Value But Keeping Current Time Unit",
      () {
        late YearUnitEntity instance = YearUnitEntity(ZEROED_TIME_UNIT_VALUE);
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          WEEK_IN_YEAR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          DAY_IN_YEAR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          HOUR_IN_YEAR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          MINUTE_IN_YEAR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          SECOND_IN_YEAR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          MILLISECOND_IN_YEAR_CONVERSION_MULTIPLIER,
        );
