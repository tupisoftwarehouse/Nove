...
void main() {
  group("Test \"HourUnitEntity\" Entity", () {
    test(
      "Test If Method \"convertTo\" Converts To Time Unit Value But Keeping Current Time Unit",
      () {
        late HourUnitEntity instance = HourUnitEntity(ZEROED_TIME_UNIT_VALUE);
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          YEAR_IN_HOUR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          WEEK_IN_HOUR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          DAY_IN_HOUR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          MINUTE_IN_HOUR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          SECOND_IN_HOUR_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          MILLISECOND_IN_HOUR_CONVERSION_MULTIPLIER,
        );
