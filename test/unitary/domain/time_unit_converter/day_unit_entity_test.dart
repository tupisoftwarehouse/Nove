...
void main() {
  group("Test \"DayUnitEntity\" Entity", () {
    test(
      "Test If Method \"convertTo\" Converts To Time Unit Value But Keeping Current Time Unit",
      () {
        late DayUnitEntity instance = DayUnitEntity(ZEROED_TIME_UNIT_VALUE);
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          WEEK_IN_DAY_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          HOUR_IN_DAY_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          MINUTE_IN_DAY_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          SECOND_IN_DAY_CONVERSION_MULTIPLIER,
        );
        ...
        formattedValue = MeasureUnitValueFormatter.getFormattedValue(
          TIME_UNIT_VALUE,
          MILLISECOND_IN_DAY_CONVERSION_MULTIPLIER,
        );
