...
void main() {
  group("Test \"Converting Length Unit\" Integration", () {
    late bool isLengthUnitConverted;
    late bool isMeasureUnitUpdated;
    late LengthUnitEntity lengthUnitToBeConvertedImplementation;
    late LengthUnitEntity updatedLengthUnitImplementation;
    ...
    setUpAll(() {
      ...
      lengthUnitToBeConvertedImplementation = LENGTH_UNIT_TO_CONVERT_TO((_) {
        isLengthUnitConverted = true;
      });

      updatedLengthUnitImplementation = UPDATED_LENGTH_UNIT((_) {
