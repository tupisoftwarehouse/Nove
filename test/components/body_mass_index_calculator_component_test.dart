...
void main() {
  group("Test \"BodyMassIndexCalculator\" Component", () {
    test("Test Getting Body Mass Index Of Candidate", () {
      ...
      final underweightBodyMassIndex = BodyMassIndexCalculator.getBodyMassIndex(
      ...
      final overweightBodyMassIndex = BodyMassIndexCalculator.getBodyMassIndex(
      ...
      expect(underweightBodyMassIndex.value, UNDERWEIGHT_BODY_MASS_INDEX_VALUE);
      expect(
      ...
      expect(normalBodyMassIndex.category, BodyMassIndexCategory.NORMAL_WEIGHT);
